...
CREATE TABLE users (
    ...
    role ENUM('admin', 'registrar', 'instructor', 'student') NOT NULL,
...
-- ============================================
-- Grant Privileges (for production use)
-- ============================================
-- GRANT ALL PRIVILEGES ON tesda_db.* TO 'tesda_user'@'localhost' IDENTIFIED BY 'your_password';
-- FLUSH PRIVILEGES;
