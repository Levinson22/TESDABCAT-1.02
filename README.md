...
- Accept and validate submitted grades
...
3. **instructors** - Instructor profile information
4. **courses** - Available courses/subjects
5. **class_sections** - Class sections with instructor assignments
6. **enrollments** - Student enrollments in sections
7. **grades** - Student grades (midterm, final, computed)
8. **transcripts** - Transcript generation records
